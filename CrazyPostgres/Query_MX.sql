...
SELECT author.name FROM pub_count_2A JOIN author ON pub_count_2A.aid = author.aid;
...
SELECT author.name FROM pub_count_2B JOIN author ON pub_count_2B.aid = author.aid;
